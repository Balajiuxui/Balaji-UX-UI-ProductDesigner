      ...
      <div className="container">
        ...
        <div className="containerwithimage">
          ...
          <div className="image-wrapper-case">
            <div className="case-study-image-box"></div>
          </div>
        </div>
        ...
        <div className="containerwithimage">
          <div className="case-study-container">
            ...
            <p className="case-study-container-p body-base">
              A concept project where I applied full design thinking methodology
              to take an abstract user need and convert it into a working
              prototype — fast.
            </p>
            <button
              className="read-case-stude-button button"
